...
class NFe310(NFe200):
    ...
    def _nfe_identification(self, cr, uid, ids, inv, company, nfe_environment, context=None):
        ...
        #mudanca
        self.nfe.infNFe.ide.dhEmi.valor = datetime.strptime('2015-06-06 00:00:00', '%Y-%m-%d %H:%M:%S')
        self.nfe.infNFe.ide.dhSaiEnt.valor = datetime.strptime('2015-06-06 00:00:00', '%Y-%m-%d %H:%M:%S')
