    ...
    for inv in pool.get('account.invoice').browse(cr, uid, ids, context={'lang': 'pt_BR'}):
        ...
        if nfe_version == '3.10':
            ...
            StrRegB['dhEmi'] = str(pytz.utc.localize(
                ...
                #datetime.strptime('2015-06-06 00:00:00', '%Y-%m-%d %H:%M:%S')).astimezone(tz)).replace(' ', 'T') or ''
            ...
            #StrRegB['dSaiEnt'] = str(datetime.strptime('2015-06-06 00:00:00', '%Y-%m-%d %H:%M:%S').date()) or ''
        ...
        if nfe_version == '3.10':
            ...
            StrE = 'E|%s|%s|%s|%s|%s|%s|\n' % (
                StrRegE['xNome'], StrRegE['indIEDest'], StrRegE['IE'], StrRegE['ISUF'], StrRegE['IM'], StrRegE['email'])
        ...
        for inv_line in inv.invoice_line:
            ...
            if nfe_version == '3.10':
                ...
                StrI = 'I|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|\n' % (
                    ...
                    StrRegI['EXTIPI'], StrRegI['CFOP'], StrRegI['UCom'],
...
#                     StrFile += StrI25
	    ...
	    #Jefferson 19/06/15
           ...
           #Jefferson 19/06/15
            ...
            if inv_line.cofins_percent == 0 and not cofins_cst in ('99', '49','07'):
                StrS04 = 'S04|%s|\n' % cofins_cst
                StrFile += StrS04
        ...
        StrRegZ = {
                   #mudanca
            'InfAdFisco': normalize('NFKD', unicode('')).encode('ASCII', 'ignore'),
